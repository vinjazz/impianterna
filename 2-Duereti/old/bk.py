...
def test_logger():
    ...
    try:
        ...
        print(
            f"\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\Duereti\\Logs\\")
...
def check_log_creation():
    ...
    log_pattern = f"\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\Duereti\\Logs\\{year}\\{month}\\TEST\\*.log"
