...
class FlowLogger:
    def __init__(self, flow_name):
        ...
        self.base_path = r"\\group.local\SHAREDIR\Brescia\V002\DIRCOM\PREVENT\PREVENTIVISTI\FLUSSI_GAUDI\Duereti\Logs"
...
def get_latest_filename_in_directory(directory, pattern="*.xml"):
    """Ottiene solo il nome del file più recente in una directory"""
    latest_file = get_latest_file_in_directory(directory, pattern)
    if latest_file:
