...
def write_files_starting_with_G03():
    ...
    try:
        folder_path = r"\\group.local\SHAREDIR\Brescia\V002\DIRCOM\PREVENT\PREVENTIVISTI\FLUSSI_GAUDI\Reti+\LOG G03 E G04"
...
def move_files():
    ...
    try:
        source_folder = r"\\group.local\SHAREDIR\Brescia\V002\DIRCOM\PREVENT\PREVENTIVISTI\FLUSSI_GAUDI\Reti+\LOG G03 E G04"
        destination_folder = r"\\group.local\SHAREDIR\Brescia\V002\DIRCOM\PREVENT\PREVENTIVISTI\FLUSSI_GAUDI\Reti+\LOG G03 E G04\old"
    ...
    try:
        ...
        try:
            cerca_file_e_controlla_testo_csv(
                r"\\group.local\SHAREDIR\Brescia\V002\DIRCOM\PREVENT\PREVENTIVISTI\FLUSSI_GAUDI\Reti+\LOG G03 E G04",
                "G03",
...
if __name__ == "__main__":
    try:
        ...
        print("=" * 60)
        print("📁 Log salvati in: \\\\group.local\\...\\Reti+\\Logs\\YYYY\\MM\\F91\\")
        print("=" * 60)
