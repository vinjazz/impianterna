...
def flussoG04():
    ...
    xmlparse = Xet.parse(
        '\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\Reti+\\1-Esercibili\\' + str(get_most_recent_xml()))
    ...
    try:
        ...
        Move_file.move_file(
            '\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\Reti+\\1-Esercibili\\')
