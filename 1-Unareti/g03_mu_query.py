...
def write_G03_MU_query():
    ...
    try:
        csv_path = r"\\group.local\SHAREDIR\Brescia\V002\DIRCOM\PREVENT\PREVENTIVISTI\FLUSSI_GAUDI\Unareti\G12\G12.csv"
    ...
    {result_string}
        ...
        filename = f"\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\Unareti\\update_query\\G03_MU_Query_{timestamp}.txt"
