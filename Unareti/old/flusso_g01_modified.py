...
def g01_controllo_query():
    global logger
    csv_path = '\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\Unareti\\G01\\G01.csv'
...
def flussoG01New():
    ...
    try:
        ...
        xml_filename = f"\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\Unareti\\G01_{datetime.now().strftime('%d%m%Y%H%M%S')}.xml"
