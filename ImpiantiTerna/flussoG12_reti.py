...
def flussoG12Reti():
    ...
    tree.write(f"\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\reti+\\G12_{datetime.now().strftime('%d%m%Y%H%M%S')}.xml", short_empty_elements=False)
