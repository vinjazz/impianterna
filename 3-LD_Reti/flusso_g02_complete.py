...
def gestisci_file_g02():
    ...
    try:
        directory = "\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\LD_Reti"
...
def flussoG02():
    ...
    try:
        ...
        basepath = r'\\group.local\SHAREDIR\Brescia\V002\DIRCOM\PREVENT\PREVENTIVISTI\FLUSSI_GAUDI\LD_Reti\4-Registrati'
        ...
        with open(csv_path) as csv_file:
            ...
            output_root = ET.Element("VALIDA_IMPIANTI", COD_SERVIZIO="G02", COD_FLUSSO="0050", 
                                   TERNA_PIVA="05779661007", GESTORE_PIVA="01341400198")
            ...
            output_xml_path = f"\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\LD_Reti\\G02_{datetime.now().strftime('%d%m%Y%H%M%S')}.xml"
