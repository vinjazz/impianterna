...
def write_files_starting_with_G03():
    ...
    try:
        folder_path = r"\\group.local\SHAREDIR\Brescia\V002\DIRCOM\PREVENT\PREVENTIVISTI\FLUSSI_GAUDI\LD_Reti\LOG G03 E G04"
...
"""
        ...
        if query_total:
            ...
            filename = f"\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\LD_Reti\\update_query\\G03_Update_{timestamp}.txt"
...
"""
        ...
        if query_total:
            ...
            now = datetime.datetime.now()
            timestamp = now.strftime("%Y-%m-%d_%H-%M-%S")
            filename = f"\\\\group.local\\SHAREDIR\\Brescia\\V002\\DIRCOM\\PREVENT\\PREVENTIVISTI\\FLUSSI_GAUDI\\LD_Reti\\update_query\\G04_Update_{timestamp}.txt"
...
def move_files():
    ...
    try:
        source_folder = r"\\group.local\SHAREDIR\Brescia\V002\DIRCOM\PREVENT\PREVENTIVISTI\FLUSSI_GAUDI\LD_Reti\LOG G03 E G04"
        destination_folder = r"\\group.local\SHAREDIR\Brescia\V002\DIRCOM\PREVENT\PREVENTIVISTI\FLUSSI_GAUDI\LD_Reti\LOG G03 E G04\old"
    ...
    try:
        ...
        try:
            cerca_file_e_controlla_testo_csv(
                r"\\group.local\SHAREDIR\Brescia\V002\DIRCOM\PREVENT\PREVENTIVISTI\FLUSSI_GAUDI\LD_Reti\LOG G03 E G04",
                "G03",
...
if __name__ == "__main__":
    try:
        ...
        print("=" * 60)
        print("📁 Log salvati in: \\\\group.local\\...\\LD_Reti\\Logs\\YYYY\\MM\\F91\\")
        print("=" * 60)
